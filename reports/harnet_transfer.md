...
- **Pearson r = +0.924, Spearman ρ = +0.780** (n = 14 Folds).
- Schwaechste 3 Folds — RF: ['P07', 'P12', 'P15']; harnet: ['P07', 'P12', 'P09']. Gemeinsam schwach: ['P07', 'P12'].
- P07: RF 0.886 / harnet 0.847 (Δ -0.039) · P09: RF 0.945 / harnet 0.943 (Δ -0.002).
- harnet besser in 4/14 Folds, mean |ΔAUC| = 0.010; harnet rettet keinen RF-schwachen Fold.
...
Einschraenkung: Fold-Korrelation ≠ Per-Window-Fehler-Korrelation — ein Proba-Ensemble (RF + harnet) koennte innerhalb der Folds noch marginal helfen, aber bei r = 0.92 ist ein Headline-Sprung unwahrscheinlich. Der entscheidende Test waere die Per-Window-OOF-Fehler-Korrelation (harnet-OOF an `loso_oof.csv` per `t_center_ms` alignen).
